...
lib.ssMetadata = [
		{name:"300x600_school_atlas_P_1", frames: [[0,0,600,500],[602,0,323,333],[602,471,256,78],[602,335,322,134]]}
];
...
(lib.bg3pngcopy = function() {
	this.initialize(ss["300x600_school_atlas_P_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AgTAnQgGgDgEgEQgEgGgBgGIgBgNIAAgxIALAAIAAAxIAAAJQACAFACAEQACADAEACQAEADAHAAQAEAAAGgCQAFgCAEgEQAEgFACgGQACgGABgIIAAgqIAKAAIAAA7IAAAGIABAGIAAAHIAAAFIgLAAIAAgJIAAgGIgBAAQgDAHgHAEQgIAGgJAAQgKAAgGgEg");
	this.shape.setTransform(133.8,-4.45);
	...
	this.shape_1.setTransform(124.55,-4.575);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AgfA/IgFgBIABgKIAEABIAGABIAFgBIADgEIADgEIADgGIAHgTIgihSIANAAIAaBFIAahFIAMAAIgpBsQgEAIgFAEQgFAFgJAAg");
	this.shape_2.setTransform(116.05,-2.4);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AADA1QgDgCgDgDIgEgHIgBgIIAAg1IgSAAIAAgKIASAAIAAgXIAKAAIAAAXIAYAAIAAAKIgYAAIAAA1QAAAGADADQADADAGAAIAGgBIAGgCIABAKIgHACIgHABQgGgBgEgBg");
	this.shape_3.setTransform(106.225,-5.65);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AgEA+IAAhSIAJAAIAABSgAgEgvQgDgCAAgEQAAgEADgCQACgCACAAQADAAADACQACACAAAEQAAAEgCACQgDACgDAAQgCAAgCgCg");
	this.shape_4.setTransform(102.15,-6.6);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AgTAnQgHgDgDgEQgDgGgBgGIgCgNIAAgxIALAAIAAAxIABAJQABAFACAEQACADAEACQAEADAGAAQAFAAAGgCQAFgCAEgEQAEgFACgGQACgGAAgIIAAgqIAMAAIAAA7IAAAGIAAAGIAAAHIAAAFIgLAAIAAgJIgBgGIAAAAQgDAHgIAEQgHAGgKAAQgJAAgGgEg");
	this.shape_5.setTransform(95.95,-4.45);
	...
	this.shape_6.setTransform(88.025,-4.575);
	...
	this.shape_7.setTransform(76.4,-4.575);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AADA1QgDgCgDgDIgEgHIgBgIIAAg1IgSAAIAAgKIASAAIAAgXIAKAAIAAAXIAYAAIAAAKIgYAAIAAA1QAAAGADADQADADAGAAIAGgBIAGgCIABAKIgHACIgHABQgGgBgEgBg");
	this.shape_8.setTransform(69.025,-5.65);
	...
	this.shape_9.setTransform(59.475,-4.575);
	...
	this.shape_10.setTransform(51.75,-4.675);
	...
	this.shape_11.setTransform(43.05,-4.575);
	...
	this.shape_12.setTransform(34.2,-4.575);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AgEBEIAAiHIAKAAIAACHg");
	this.shape_13.setTransform(27.7,-7.2);
	...
	this.shape_14.setTransform(20.5,-4.675);
...
// stage content:
(lib._300x600_school = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.instance_3.setTransform(162,262.5,1,1,0,0,0,68,9.5);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(215).to({_off:false},0).to({x:182,alpha:1},10).wait(24).to({scaleX:1.1357,scaleY:1.1357,x:182.05,y:262.55},6).to({scaleX:1,scaleY:1,x:182,y:262.5},5).wait(10).to({scaleX:1.1357,scaleY:1.1357,x:182.05,y:262.55},6).to({scaleX:1,scaleY:1,x:182,y:262.5},5).wait(10));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(215).to({_off:false},0).to({x:195.3,alpha:1},10).wait(66));

	// curve_rotate
	this.instance_5 = new lib.curve_rotate_mc();
	this.instance_5.setTransform(139.5,208);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(160).to({_off:false},0).to({rotation:180,y:236},15).wait(116));

	// curve
	this.instance_6 = new lib.curve_mc();
	this.instance_6.setTransform(95,143);
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_4 = new cjs.Graphics().p("AiMCNIAAkZIEZAAIAAEZg");
	var mask_graphics_7 = new cjs.Graphics().p("AjZCWIAAgTIkZAAIAAkYIPlAAIAAErg");
	var mask_graphics_10 = new cjs.Graphics().p("AmfCWIAAgTIkaAAIAAkYIPlAAIAAAUIGNAAIAAEIImNAAIAAAPg");
	var mask_graphics_13 = new cjs.Graphics().p("Aq5EyIAApjIPlAAIAAAUIGNAAIAAEJImNAAIAAAPIhLAAIAAE3g");
	var mask_graphics_16 = new cjs.Graphics().p("Ar3EyIAApjIPlAAIAAAUIGNAAIAAD/IB9AAIAAFLIpWAAIAAAFg");
	var mask_graphics_19 = new cjs.Graphics().p("Ar5HCIAAkEIJpAAIAAEEgAr1CjIAApkIPlAAIAAAUIGNAAIAAD/IB9AAIAAFLIpVAAIAAAGg");
	var mask_graphics_22 = new cjs.Graphics().p("AhjHIIAAksIqSAAIAApjIPlAAIAAAUIGNAAIAAD/IB9AAIAAFLIpVAAIAAAFIG7AAIAAEsgAr5G8IAAkEIJpAAIAAEEg");
	var mask_graphics_25 = new cjs.Graphics().p("Ar5JrIAApWIJpAAIAAEEIkYAAIAAFSgAhjEmIAAkrIqSAAIAAplIPlAAIAAAUIGNAAIAAD/IB9AAIAAFNIpVAAIAAAFIG7AAIAAErg");
	var mask_graphics_28 = new cjs.Graphics().p("Al4JvIAAlBILRAAIAAFBgAr5JnIAApWIJpAAIAAEEIkYAAIAAFSgAhjEiIAAkrIqSAAIAAplIPlAAIAAAVIGNAAIAAD/IB9AAIAAFMIpVAAIAAAFIG7AAIAAErg");
	var mask_graphics_31 = new cjs.Graphics().p("Al4JvIAAlBIJ7AAIAAgMIlmAAIAAkrIqSAAIAAplIPlAAIAAAVIGNAAIAAD/IB9AAIAAFMIpVAAIAAAFIG7AAIAAErIgkAAIAAE0IjjAAIAAAZgAr5JnIAApWIJpAAIAAEEIkYAAIAAFSg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(4).to({graphics:mask_graphics_4,x:21.55,y:116.05}).wait(3).to({graphics:mask_graphics_7,x:57.375,y:117}).wait(3).to({graphics:mask_graphics_10,x:77.25,y:117}).wait(3).to({graphics:mask_graphics_13,x:77.25,y:132.625}).wait(3).to({graphics:mask_graphics_16,x:83.5,y:132.625}).wait(3).to({graphics:mask_graphics_19,x:83.25,y:147}).wait(3).to({graphics:mask_graphics_22,x:83.25,y:147.625}).wait(3).to({graphics:mask_graphics_25,x:83.25,y:163.875}).wait(3).to({graphics:mask_graphics_28,x:83.25,y:164.25}).wait(3).to({graphics:mask_graphics_31,x:83.25,y:164.25}).wait(260));
...
p.nominalBounds = new cjs.Rectangle(101.1,300,210.1,550);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/300x600_school_atlas_P_1.png?1614767160875", id:"300x600_school_atlas_P_1"}
	],
	preloads: []
};
