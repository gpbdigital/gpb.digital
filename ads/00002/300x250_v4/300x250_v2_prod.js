...
p.nominalBounds = new cjs.Rectangle(0,0,322,134);// helper functions:
...
if (reversed == null) { reversed = false; }
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(188.55,8.975);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("");
	this.shape_1.setTransform(180.4,8.975);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AgiAsIAAgHIA0hGIgyAAIAAgKIBBAAIAAAHIgzBGIA2AAIAAAKg");
	this.shape_2.setTransform(172.1,8.95);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AgFBBIAAhWIAKAAIAABWgAgGgyQgBgDAAgDQAAgDABgDQADgDADABQAEgBACADQACADABADQgBADgCADQgCADgEAAQgDAAgDgDg");
	this.shape_3.setTransform(166.8,6.8);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("");
	this.shape_4.setTransform(161.35,8.975);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AgFBIIAAiPIALAAIAACPg");
	this.shape_5.setTransform(152.275,6.175);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AgFBIIAAiPIALAAIAACPg");
	this.shape_6.setTransform(148.725,6.175);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("");
	this.shape_7.setTransform(142.4,8.975);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AgKBJIAAhNIgSAAIAAgKIASAAIAAgcQAAgJADgGQADgFADgEQADgDAFgBIAJgCQAIAAAFADIgDAJQgDgCgHABQgPAAAAAWIAAAZIAUAAIAAAKIgUAAIAABNg");
	this.shape_8.setTransform(132.325,6.05);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("");
	this.shape_9.setTransform(124.5,8.975);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("");
	this.shape_10.setTransform(111.8,8.975);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AAbAtIAAgzIgCgKIgDgJQgCgEgFgDQgDgCgIAAQgFAAgFACQgGACgEAFQgEAFgCAGQgDAHAAAIIAAAsIgMAAIAAg+IAAgGIAAgHIAAgHIAAgFIALAAIABAJIAAAHIABAAQADgIAIgFQAIgFAJAAQALAAAHADQAFAEAEAEQAEAGACAGQABAIAAAHIAAAzg");
	this.shape_11.setTransform(103.6,8.85);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("");
	this.shape_12.setTransform(94.3,8.975);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("");
	this.shape_13.setTransform(84.9,8.975);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("AgFBIIAAiPIALAAIAACPg");
	this.shape_14.setTransform(77.975,6.175);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("");
	this.shape_15.setTransform(67.55,8.975);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFFFFF").s().p("");
	this.shape_16.setTransform(55.15,8.85);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFFFFF").s().p("");
	this.shape_17.setTransform(42.5,8.975);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#FFFFFF").s().p("AAaBIIAAg0IgBgKIgDgJQgCgDgFgDQgEgCgHAAQgFAAgGACQgFACgEAEQgEAEgDAHQgCAHAAAJIAAAsIgMAAIAAiPIAMAAIAABHIAAAAQAEgHAIgFQAIgFAJAAQALAAAGADQAGADAEAFQAEAGABAFQACAHAAAIIAAA0g");
	this.shape_18.setTransform(32.575,6.175);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#FFFFFF").s().p("AgWAtIAAg+IAAgGIAAgHIAAgHIAAgFIALAAIAAAJIABAHQAEgIAGgFQAHgFAKAAIADAAIADABIgBALIgEgBQgIAAgFACQgFADgDAEQgEAEgBAGQgCAGAAAGIAAAvg");
	this.shape_19.setTransform(21.875,8.85);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#FFFFFF").s().p("");
	this.shape_20.setTransform(13.5,8.975);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#FFFFFF").s().p("AgnBDIAAiFIBPAAIAAALIhDAAIAAAwIA/AAIAAAKIg/AAIAABAg");
	this.shape_21.setTransform(4.175,6.625);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape},{t:this.text}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.loans_mc, new cjs.Rectangle(-3.7,-12.4,197.6,34.7), null);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(103.625,11.475);
	...
	this.shape_8.setTransform(5.75,11.475);
...
}).prototype = getMCSymbolPrototype(lib.cta_mc, new cjs.Rectangle(-2.9,-32.6,163.4,59.8), null);
...
// stage content:
(lib._300x250_v2 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(160).to({_off:false},0).to({rotation:180},15).wait(15).to({regX:122,regY:104,x:28,y:21},0).to({regX:121.8,regY:103.9,scaleX:0.7876,scaleY:0.7876,x:8,y:10.95},10).wait(91));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg3.png?1614338343566", id:"bg3"},
		{src:"images/curve.png?1614338343566", id:"curve"},
		{src:"images/logo1.png?1614338343566", id:"logo1"},
		{src:"images/logo2.png?1614338343566", id:"logo2"}
	],
	preloads: []
};
