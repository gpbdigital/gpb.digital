...
if (reversed == null) { reversed = false; }
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(578.55,8.575);
	...
	this.shape_3.setTransform(547.675,5.625);
	...
	this.shape_4.setTransform(539.8,8.575);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AgHBiIAAjDIAPAAIAADDg");
	this.shape_5.setTransform(526.675,4.775);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AgHBiIAAjDIAPAAIAADDg");
	this.shape_6.setTransform(521.475,4.775);
	...
	this.shape_7.setTransform(512.5,8.575);
	...
	this.shape_8.setTransform(497.9,4.625);
	...
	this.shape_9.setTransform(486.825,8.575);
	...
	this.shape_10.setTransform(468.6,8.575);
	...
	this.shape_11.setTransform(457.025,8.425);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("");
	this.shape_12.setTransform(444,8.575);
	...
	this.shape_13.setTransform(430.725,8.575);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("AgHBiIAAjDIAPAAIAADDg");
	this.shape_14.setTransform(420.925,4.775);
...
}).prototype = getMCSymbolPrototype(lib.loans_mc, new cjs.Rectangle(0,-13.4,585.5,39.5), null);
...
}).prototype = getMCSymbolPrototype(lib.curve_rotate_mc, new cjs.Rectangle(-98,-13.9,762.4,101.7), null);
...
if (reversed == null) { reversed = false; }
	...
	var mask_graphics_7 = new cjs.Graphics().p("AgeCdIAAk5IJYAAIAAE5gAo5CIIAAkgIIEAAIAAEgg");
	var mask_graphics_10 = new cjs.Graphics().p("AlRCmIAAk5IJXAAIAAE5gAEVCUIAAk5IJZAAIAAE5gAttCRIAAkgIIEAAIAAEgg");
	var mask_graphics_13 = new cjs.Graphics().p("AqdCmIAAk5IJYAAIAAE5gAJhCjIAAk5IJZAAIAAE5gAg2CUIAAk5IJYAAIAAE5gAy5CRIAAkgIIEAAIAAEgg");
	var mask_graphics_16 = new cjs.Graphics().p("AxlEtIAAkhIHIAAIAAknIJYAAIAAE5IocAAIAAEPgAJhAcIAAk6IJZAAIAAE6gAg2AMIAAk5IJYAAIAAE5gAy5AKIAAkgIIEAAIAAEgg");
	var mask_graphics_19 = new cjs.Graphics().p("AxlEtIAAkhIHIAAIAAknIJYAAIAAEPIAPAAIAAkhIJYAAIAAE5IpYAAIAAEhgAJhAcIAAk6IJZAAIAAE6gAy5AKIAAkgIIEAAIAAEgg");
	var mask_graphics_22 = new cjs.Graphics().p("AxlEtIAAkhIHIAAIAAknIJYAAIAAEPIAPAAIAAkhIJYAAIAAE5Im0AAIAAEhgAJhAcIAAk6IJZAAIAAE6gAy5AKIAAkgIIEAAIAAEgg");
	var mask_graphics_25 = new cjs.Graphics().p("AgrE5IAAgYIw6AAIAAkhIHIAAIAAknIJYAAIAAEPIAPAAIAAkhIJYAAIAAEhIA/AAIAAkSIJZAAIAAE6InFAAIAAERIkdAAIAAAYgABuAZIAvAAIAAgZIgvAAgAy5gBIAAkhIIEAAIAAEhg");
	var mask_graphics_28 = new cjs.Graphics().p("AJbE5IAAgYIjtAAIAAAYIoDAAIAAgYIw6AAIAAkhIHIAAIAAknIJYAAIAAEPIAPAAIAAkhIJYAAIAAEhIA/AAIAAkSIJZAAIAAE6InFAAIAAAJIKbAAIAAEggAAEAZIAvAAIAAgZIgvAAgA0lgBIAAkhIIEAAIAAEhg");
	var mask_graphics_31 = new cjs.Graphics().p("AHyE5IAAgYIjtAAIAAAYIoDAAIAAgYIw6AAIAAkhIHHAAIAAknIJZAAIAAEPIAPAAIAAkhIJXAAIAAEhIBAAAIAAkSIJYAAIAAEPIGpAAIAAEgIjSAAIAAA0gAIiAZIFpAAIAAgJIlpAAgAhkAZIAuAAIAAgZIguAAgA2PgBIAAkhIIEAAIAAEhg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(4).to({graphics:mask_graphics_4,x:26,y:24.75}).wait(3).to({graphics:mask_graphics_7,x:65.1,y:29.5}).wait(3).to({graphics:mask_graphics_10,x:95.875,y:28.6}).wait(3).to({graphics:mask_graphics_13,x:129.075,y:28.6}).wait(3).to({graphics:mask_graphics_16,x:129.075,y:42.15}).wait(3).to({graphics:mask_graphics_19,x:129.075,y:42.15}).wait(3).to({graphics:mask_graphics_22,x:129.075,y:42.15}).wait(3).to({graphics:mask_graphics_25,x:129.075,y:43.35}).wait(3).to({graphics:mask_graphics_28,x:139.925,y:43.35}).wait(3).to({graphics:mask_graphics_31,x:150.45,y:43.35}).wait(129).to({graphics:null,x:0,y:0}).wait(130));
...
p.nominalBounds = new cjs.Rectangle(350.3,-121.6,377.7,380.6);
// library properties:
lib.properties = {
